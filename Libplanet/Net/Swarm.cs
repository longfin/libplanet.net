...
namespace Libplanet.Net
{
        ...
        where T : IAction, new()
    {
        ...
        private static readonly TimeSpan BlockHashRecvTimeout = TimeSpan.FromSeconds(15 * 10);
        private static readonly TimeSpan BlockRecvTimeout = TimeSpan.FromSeconds(15 * 10);
        private static readonly TimeSpan TxRecvTimeout = TimeSpan.FromSeconds(15 * 10);
