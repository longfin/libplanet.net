    ...
    public class FileStore : IStore
    {
        ...
        public override HashDigest? IndexBlockHash(long index)
        {
            ...
            using (var f = IndexFileStream())
            {
                ...
                f.Seek(HashDigest.HashSize * index, SeekOrigin.Begin);
                var bytesRead = f.Read(blockHash, 0, HashDigest.HashSize);
                if (bytesRead == HashDigest.HashSize)
                {
...
*/
        ...
        private FileStream IndexFileStream()
        {
            ...
            if (index.Length % HashDigest.HashSize != 0)
            {
                throw new FileLoadException(
